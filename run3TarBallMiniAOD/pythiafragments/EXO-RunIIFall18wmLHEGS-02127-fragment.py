...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/s/sdogra/work/DarkMatter/GenProd/genproductions/bin/MadGraph5_aMCatNLO/SIDM_BsTo2DpTo4Mu_MBs-500_MDp-0p25_ctau-3p75_el9_amd64_gcc11_CMSSW_13_2_9_tarball.tar.xz'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'Zprime:vu=0.0',
            'Zprime:au=0.0',
            'Zprime:ve=5.92927061281571e-06',
            'Zprime:vnue=0.0',
            'Zprime:ae=0.0',
            'Zprime:anue=0.0',
        ),
