...
cd ../../
 cmsDriver command
cmsDriver.py step2  --python_filename ${outfilename}_sim.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:${outfilename}_sim.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --filein file:${outfilename}_gen.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 9999
...
# cmsDriver command
cmsDriver.py step5 --python_filename ${outfilename}_reco_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:${outfilename}_RECO.root --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:${outfilename}_HLT.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 9999
...
cmsDriver.py step6 --python_filename ${outfilename}_miniaod_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:${outfilename}_miniaod.root --conditions 106X_mcRun2_asymptotic_v17 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:${outfilename}_RECO.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 9999
...
#xrdcp  ${outfilename}_miniaod.root  root://cmseos.fnal.gov//store/group/lpcmetx/Monotop/Signal20UL16MiniAODv2/2016post/${dirname}/Monotop_${dirname}_${TempNumber}_miniaod.root
#xrdcp ${outfilename}_miniaod.root   root://cluster142.knu.ac.kr//store/user/sdogra/Znunugamma/2016Post/MC_${dirname}_${TempNumber}_miniaod.root
xrdcp ${outfilename}_miniaod.root   root://cluster142.knu.ac.kr//store/user/sdogra/ZLLGJet/MiniAOD/2016Post/${dirname}/MC_${dirname}_${TempNumber}_miniaod.root
echo "Copy  DONE."
