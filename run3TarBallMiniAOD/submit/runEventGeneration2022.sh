...
cmsDriver.py Configuration/GenProduction/python/${HADRONIZER} --python_filename ${outfilename}_gensim.py  --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:${outfilename}_gensim.root --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.source.numberEventsInLuminosityBlock="cms.untracked.uint32(212)"\\nprocess.RandomNumberGeneratorService.externalLHEProducer.initialSeed="int(${RANDOMSEED})" --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 1000
...
#xrdcp ${outfilename}_RECO.root    root://cmseos.fnal.gov//store/group/lpcmetx/SIDM/ULSignalSamples/RECOAOD/2022_v1/${dirname}/MC_${dirname}_${TempNumber}_aod.root
...
#xrdcp ${outfilename}_miniaod.root root://cluster142.knu.ac.kr//store/user/sdogra/WZAToLNuLLA/MiniAOD/2022/${dirname}/MC_${dirname}_${TempNumber}_miniaod.root
#xrdcp ${outfilename}_Premix.root   root://cluster142.knu.ac.kr//store/user/sdogra/SIDM/2022/Premix/${dirname}_v1/MC_${dirname}_${TempNumber}_Premix.root
xrdcp ${outfilename}_nanoaod.root root://cluster142.knu.ac.kr//store/user/sdogra/${dirname}/2022/MC_${dirname}_${TempNumber}_nanoaod.root
echo "Copy  DONE."
