...
cmsDriver.py Configuration/GenProduction/python/${HADRONIZER} --python_filename ${outfilename}_gensim.py  --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:${outfilename}_gensim.root --conditions 140X_mcRun3_2024_realistic_v26 --beamspot DBrealistic --customise_commands "process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(${RANDOMSEED})"  --step GEN,SIM --geometry DB:Extended --era Run3_2024 --no_exec --mc -n 1000
...
xrdcp ${outfilename}_miniaod.root   root://cluster142.knu.ac.kr//store/user/sdogra/GJet_PT_15to6000/MiniAOD/2024v1/${dirname}/MC_${dirname}_${TempNumber}_miniaod.root
echo "Copy  DONE."
